<template>
  <article>
    <h1>How the recommendation bot works:</h1>
    <p>Using natural language processing techniques, the bot assesses the words used in a comment and derives a <span class="highlight">probability</span> of insightfulness score for each comment. </p>
